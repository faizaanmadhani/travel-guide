...
import { addFederationToSchema, federationSpec } from '@graphql-codegen/visitor-plugin-common';
import { isScalarType, parse, visit, printSchema } from 'graphql';
...
export const addToSchema = config => {
