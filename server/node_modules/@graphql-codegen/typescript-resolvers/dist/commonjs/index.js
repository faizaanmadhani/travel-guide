...
exports.TypeScriptResolversVisitor = visitor_1.TypeScriptResolversVisitor;
exports.plugin = (schema, documents, config) => {
    ...
    const transformedSchema = config.federation ? visitor_plugin_common_1.addFederationToSchema(schema) : schema;
    const visitor = new visitor_1.TypeScriptResolversVisitor(config, transformedSchema);
...
`;
    const printedSchema = config.federation ? graphql_toolkit_1.printSchemaWithDirectives(transformedSchema) : graphql_1.printSchema(transformedSchema);
...
exports.addToSchema = config => {
    return config.federation ? visitor_plugin_common_1.federationSpec : undefined;
};
