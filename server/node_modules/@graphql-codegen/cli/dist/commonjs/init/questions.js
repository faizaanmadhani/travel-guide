...
function getQuestions(possibleTargets) {
    return [
        ...
        },
        {
            ...
            suffix: helpers_1.grey(' (path or url)'),
        ...
        },
        {
            ...
            when: answers => {
                ...
                return answers.targets.includes(types_1.Tags.browser);
            },
            default: 'src/**/*.graphql',
            validate: (str) => str.length > 0,
        },
...
function getApplicationTypeChoices(possibleTargets) {
    function withFlowOrTypescript(tags) {
        if (possibleTargets.TypeScript) {
            tags.push(types_1.Tags.typescript);
        }
        else if (possibleTargets.Flow) {
            tags.push(types_1.Tags.flow);
        }
        else {
            tags.push(types_1.Tags.flow, types_1.Tags.typescript);
        }
        return tags;
    }
    return [
        {
            ...
            key: 'backend',
            value: withFlowOrTypescript([types_1.Tags.node]),
            checked: possibleTargets.Node,
        },
        {
            name: 'Application built with Angular',
            key: 'angular',
            value: [types_1.Tags.angular, types_1.Tags.browser, types_1.Tags.typescript],
            checked: possibleTargets.Angular,
        },
        {
            name: 'Application built with React',
            key: 'react',
            value: withFlowOrTypescript([types_1.Tags.react, types_1.Tags.browser]),
            checked: possibleTargets.React,
        },
        {
            name: 'Application built with Stencil',
            key: 'stencil',
            value: [types_1.Tags.stencil, types_1.Tags.browser, types_1.Tags.typescript],
            checked: possibleTargets.Stencil,
        },
        {
            name: 'Application built with other framework or vanilla JS',
            key: 'client',
            value: [types_1.Tags.browser, types_1.Tags.typescript, types_1.Tags.flow],
